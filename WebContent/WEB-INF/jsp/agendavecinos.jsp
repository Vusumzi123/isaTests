							...
							<form>
								<div>
									<input type="search" id="mySearch" name="q"
										placeholder="buscar vecino" size="38" style="margin-top:13px; background-color: #f1f1f1">
									<button style="background: transparent; border: none; color: #00949e; cursor: pointer">
