	...
	<div class="body-container">
		<div class="contenido">
			<div id="vecinos" class="tabcontent active">
				...
				<div class="container">
					<div class="texto1">Invita a tus vecinos a ser parte de este
						condominio. Ingresa su correo electr�nico. Tambi�n puedes
			...
			<div id="sub-administradores" class="tabcontent">
				...
				<div class="container">
					<div class="texto1">Actualmente, t� eres el administrador del
						inmueble, puedes designar a sub administradores que gestionen
						grupos m�s peque�os de vecinos para facilitar tu labor.</div>
					<div class="contenido1">
