...
<body>
	...
	<div class="body-container">
		<div class="form-container">
			<div class="notificacion-novista">
				<div class="row">
					<div class="col-sm-3">
					...
					<div class="col-sm-9">
						<div class="user">Joscelin Rojas</div>
						<div class="motivo">Te envió ficha de pago</div>
						<div class="fecha">30-abril-2018</div>
					</div>
				</div>
			</div>
			<div class="linea"></div>
			<div class="notificacion-vista">
				<div class="row">
					...
					<div class="col-sm-9">
						<div class="user">Henry Zapata</div>
						<div class="motivo">Te envió ficha de pago</div>
						<div class="fecha">30-abril-2018</div>
					</div>
				</div>
			...
			<div class="notificacion-vista">
				<div class="row">
					...
					<div class="col-sm-9">
						<div class="user">Montserrat Casillas</div>
						<div class="motivo">Te envió ficha de pago</div>
						<div class="fecha">29-abril-2018</div>
					</div>
				</div>
			</div>
		</div>
